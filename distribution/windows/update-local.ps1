...
function Build-LocalBundle([string]$Repository) {
    ...
    Write-Json (Join-Path $bundle 'manifest.json') @{version=$version;databaseSchema=8;launcherProtocol=1;uiPackageProtocol=1;target='x86_64-pc-windows-msvc';sourceRoot=$Repository}
