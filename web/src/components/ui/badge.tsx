  ...
  "inline-flex items-center gap-1 rounded-[5px] border px-[7px] py-0.5 text-[11px] font-medium leading-relaxed",
  {
    variants: {
      variant: {
        ...
        in_review: "border-transparent bg-[#e9e8fc] text-[#5745a2]",
        blocked: "border-transparent bg-[#fff0dd] text-[#95661f]",
        backlog: "border-transparent bg-muted text-muted-foreground",
        todo: "border-transparent bg-secondary text-secondary-foreground",
        done: "border-transparent bg-[#e5f2ee] text-[#247757]",
        cancelled: "border-transparent bg-[#eeeff0] text-[#737b80]",
